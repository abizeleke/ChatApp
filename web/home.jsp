    ...
    xhr.onload = function() {
      ...
      window.addEventListener('load', function() {
        ...
        <div class="textbox1">
            ...
            <!-- GROUP MESSAGE-->
<section class="group" onclick="closeDrop()">
        <div class="message">
        <div class="viewbox2">
...
<script>
    ...
    xhr2.onload = function() {
        if (xhr2.status === 200) {
            ...
            const responseDoc2 = parser2.parseFromString(xhr2.responseText, 'text/html');
            const updatedSection2 = responseDoc2.querySelector('.viewbox2');
            const section2 = document.querySelector('.viewbox2');
            section2.innerHTML = updatedSection2.innerHTML;
            section2.scrollTop = section2.scrollHeight;
        }
    };
    xhr2.send();
}
    const refreshInterval2 = 2000;
    setInterval(reloadSection2, refreshInterval2);
    window.addEventListener('load', function() {
    const section2 = document.querySelector('.viewbox2');
    section2.scrollTop = section2.scrollHeight;
});
       ...
       <% }%>
              ...
              <script>
    // Function to reload the section content
        ...
        <div class="textbox1">
            ...
            <form action="servlett.sendMessage2">
                ...
                <!-- FEEDBACK-->
<section class="feedback" onclick="closeDrop()">
...
<section class="profile" onclick="closeDrop()">
...
<section class="changePassword" onclick="closeDrop()">
