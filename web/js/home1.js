    ...
    window.onload1 = function() {
        var viewBox1=document.querySelector('.viewbox');
        viewBox1.scrollTop = viewBox1.scrollHeight;
    };
    ...
    window.onload2 = function() {
        var viewBox2=document.querySelector('.viewbox2');
        viewBox2.scrollTop = viewBox2.scrollHeight;
    };
